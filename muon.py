...
class Hyperparameters:
    # data
    train_files = "/opt/nas/p/local/llllchenhaoyullll/Code/Quant/Data/kjj0/fineweb10B-gpt2/fineweb_train_*.bin" # input .bin to train on
    val_files = "/opt/nas/p/local/llllchenhaoyullll/Code/Quant/Data/kjj0/fineweb10B-gpt2/fineweb_val_*.bin" # input .bin to eval validation loss on
